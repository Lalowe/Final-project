...
<body>
    ...
    <div class="card shadow p-5 w-70 mt-5 mb-5" style="width: 35rem";>
    <fieldset>
        <legend class='h2 mb-2'>Delete user info<br></legend>
        ...
        <h5 class="mb-4">Do you really want to delete info of this user?</h5>
        <form method="post">
